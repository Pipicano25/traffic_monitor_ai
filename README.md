...
La arquitectura integra GitHub Actions, pruebas unitarias, descarga externa del modelo y datos de prueba Gogle storage, Docker, Artifact Registry, Google Cloud Run y registro de predicciones por ambiente.
